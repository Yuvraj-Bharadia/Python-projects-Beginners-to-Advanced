...
def quiz(y):
    ...
    Button(frame1, text="33", font=("Arial", 30, "bold"),bg="light blue", command=a_right).grid(row=3, column=1)
    Button(frame1, text="31", font=("Arial", 30, "bold"),bg="light green", command=a_wrong).grid(row=3, column=2)
    Button(frame1, text="30", font=("Arial", 30, "bold"),bg="light pink", command=a_wrong).grid(row=3, column=3)
    ...
    Button(frame2, text="10", font=("Arial", 30, "bold"),bg="light pink", command= a2_wrong).grid(row=3, column=3)
